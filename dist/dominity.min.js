...
var I = function (z) {
    ...
    if (J === void 0 || J._target !== Z) {
      ...
      if (((Z._sources = J), (z._node = J), Z._flags & P)) z._subscribe(J);
      return J;
  ...
  k = function (z) {
    ...
    while (J !== void 0) {
      ...
      if (J._version === -1) {
        ...
        if (J._nextSource !== void 0) J._nextSource._prevSource = X;
      } else Q = J;
  ...
  y = function (z) {
    ...
    if ((k(this), (Z = z), (this._flags &= ~H), this._flags & j)) R(this);
    h();
  },
  U = function (z) {
    (this._fn = z),
...
w.prototype._unsubscribe = function (z) {
  if (this._targets !== void 0) {
    ...
    if (J !== void 0) (J._nextTarget = Q), (z._prevTarget = void 0);
    if (Q !== void 0) (Q._prevTarget = J), (z._nextTarget = void 0);
    if (z === this._targets) this._targets = Q;
  }
};
...
Object.defineProperty(w.prototype, 'value', {
  get() {
    const z = I(this);
    if (z !== void 0) z._version = this._version;
    return this._value;
  },
  set(z) {
    if (z !== this._value) {
...
_.prototype._refresh = function () {
  if (((this._flags &= ~K), this._flags & H)) return !1;
  if ((this._flags & (q | P)) === P) return !0;
  if (((this._flags &= ~q), this._globalVersion === O)) return !0;
  if (
...
Object.defineProperty(_.prototype, 'value', {
  get() {
    if (this._flags & H) throw new Error('Cycle detected');
    const z = I(this);
    if ((this._refresh(), z !== void 0)) z._version = this._version;
    if (this._flags & G) throw this._value;
    return this._value;
  },
});
U.prototype._callback = function () {
  const z = this._start();
  try {
    if (this._flags & j) return;
    if (this._fn === void 0) return;
    const J = this._fn();
    if (typeof J === 'function') this._cleanup = J;
  } finally {
    z();
  }
};
...
U.prototype._dispose = function () {
  if (((this._flags |= j), !(this._flags & H))) R(this);
};
var E = function (z, ...J) {
    let Q = document.createElement(z),
      X = new V(Q);
    return (
      J.forEach((W, L) => {
        if (typeof W == 'string') {
          let Y = document.createTextNode(W);
          Q.appendChild(Y);
          ...
          let Y = document.createTextNode(W.value);
          Q.appendChild(Y),
            $(() => {
              Y.data = W.value;
            });
        } else if (W instanceof V) Q.appendChild(W.elem);
        else if (
          typeof W == 'object' ||
          ...
          W.forEach((Y) => {
            if (Y instanceof V) Q.appendChild(Y.elem);
            else
              throw new Error(
...
class V {
  constructor(z) {
    if (typeof z == 'string') this.elem = document.querySelector(z);
    else this.elem = z;
    if (this.elem == null) {
  ...
  html(z) {
    if (z == null) return this.elem.innerHTML;
    else {
      if (typeof z == 'function')
        $(() => {
          this.html(z());
        });
      else this.elem.innerHTML = z;
      return this;
    }
  }
  css(z, J = void 0) {
    if (typeof z == 'string')
      ...
      else return (this.elem.style[z] = J), this;
  ...
  attr(z, J = void 0) {
    if (typeof z == 'string')
      if (J == null) return this.elem.getAttribute(z);
      else return this.elem.setAttribute(z, J), this;
    else if (typeof z == 'object') {
      let Q = Object.keys(z),
        X = Object.values(z);
      return (
        Q.forEach((W, L) => {
          ...
          else if (typeof X[L] != 'function') this.attr(W, X[L]);
  ...
  showIf(z) {
    let J = this.css('display') != 'none' ? this.css('display') : 'block';
    if (typeof z == 'function')
      return (
        $(() => {
          this.showIf(z());
    ...
    else if (z) this.elem.style.display = J;
  ...
  giveRef(z, J = !0) {
    if (z instanceof F) z.value = J ? this.elem : this;
    else z = J ? this.elem : this;
    return this;
  }
  model(z, J) {
    let Q = 'value';
    if (this.attr('type') == 'checkbox') Q = 'checked';
    if (z instanceof F) {
      if (J?.debounce == null && J?.throttle == null)
        $(() => {
          if (!(z.value instanceof Array)) this.elem[Q] = z.value;
          else if (z.value.includes(this.elem.name)) this.elem[Q] = !0;
          else this.elem[Q] = !1;
        });
      else this.elem[Q] = z.value;
      let X,
        W = 0;
      this.on('input', () => {
        ...
        if (Q == 'checked')
          if (!(z.value instanceof Array))
            if (this.elem.checked) L = !0;
            else L = !1;
          else if (this.elem.checked) L = [...z.value, this.elem.name];
          else L = z.value.filter((Y) => Y != this.elem.name);
        if (J?.debounce == null && J?.throttle == null) z.value = L;
        else if (J?.debounce)
          clearTimeout(X),
            (X = setTimeout(() => {
              z.value = L;
  ...
  animate(z, J, Q = 'linear', X = void 0) {
    ...
    Object.keys(z).forEach((Y) => {
      if (z[Y] instanceof Array) (W[Y] = z[Y][0]), (z[Y] = z[Y][1]);
      else W[Y] = this.css(Y);
    });
    let L = this.elem.animate([W, z], {
      duration: J * 1000,
      easing: Q,
      fill: 'forwards',
    });
    return (
      (L.onfinish = () => {
        if ((this.css(z), typeof X === 'function')) X(this);
      }),
      this
    );
  }
...
class v {
  ...
  setRoutes(z = {}) {
    Object.keys(z).forEach((J) => {
      ...
      if (
        ...
        this.defaultPath = J;
      if (z[J].component instanceof V) z[J].component.showIf(Q.viewKey);
      if (z[J].getComponent != null && typeof z[J].getComponent == 'function')
        $(async () => {
          if (Q.viewKey.value) {
            let W = await z[J].getComponent(this);
            if (z[J].layout != null) W = z[J].layout(W);
          ...
          } else if (z[J].componentLoaded) z[J].componentLoaded.remove();
        });
      this.routeMap[J] = Q;
    });
  }
  ...
  async assignRoute() {
    Object.keys(this.routeMap).forEach((z) => {
      let J = this.routeMap[z];
      if (window.location.pathname == z) J.viewKey.value = !0;
      else J.viewKey.value = !1;
    });
  }
  routeTo(z) {
