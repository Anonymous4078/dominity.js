class DominityElement {
  ...
  html(e = null) {
    return null == e ? this.elem.innerHTML : ((this.elem.innerHTML = e), this);
  }
  style(e, t = null) {
  ...
  _el(e, t = "", i = {}) {
    let s = e.dominityElem ? e : this.create(e);
    return (
      e.dominityElem || this.addChild(s),
      "object" == typeof t ? s.attr(t) : s.text(t).attr(i),
      s
    );
  }
  create(e) {
  ...
  model(e) {
    let t = "value";
    return (
      "checkbox" == this.attr("type") && (t = "checked"),
      e instanceof DominityReactive &&
        (e.subscribe((e) => {
  ...
  animate(e, t, i = "linear", s) {
    ...
    return (
      ...
      (this.elem.animate([l, e], {
        ...
        this.style(e), "function" == typeof s && s(this);
      }),
      this
    );
  }
...
function el(e, t = "", i = {}, s = document.body) {
  ...
  s.appendChild(l);
  let r = new DominityElement(l);
  return "object" == typeof t ? r.attr(t) : r.text(t).attr(i), r;
}
function $el(e) {
